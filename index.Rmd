...
**The talk accompanying this material can be found** [here](Bioc2023_presentation.html)
...
The intention of the package is to integrate easily with these packages, wrap multiple functions where appropriate, and provide new tools for both visualisation and working with results.
...
Data can be obtained from [here](https://github.com/smped/extraChIPs_demo_data) and should be placed in a folder called `data` within your current working directory.
...
Not that whilst we have the same number of ranges in this particular example, the ranges are tighter.
