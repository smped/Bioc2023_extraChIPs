...
2. Find overlapping regions within x% of replicates $\implies$ *consensus peaks*
    + Can be formed within treatment groups
...
- By default, the *union* of overlapping ranges will be returned (between black lines)
    
. . .
    
- Can also return only ranges *covered* by `p` samples (between red lines)
